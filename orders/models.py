...
class Vendor(models.Model):
    ...
    order_day = models.CharField(max_length=1, choices=DAYS_OF_WEEK, blank=True, null=True)
    delivery_day = models.CharField(max_length=1, choices=DAYS_OF_WEEK, blank=True, null=True)
